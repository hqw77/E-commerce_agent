...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        logisticsEventRepository.saveAll(Arrays.asList(
            new LogisticsEvent(shippedLogistics, LocalDateTime.of(2026, 4, 20, 14, 0), "跨境电商已发货"),
        ...
        logisticsEventRepository.saveAll(Arrays.asList(
            new LogisticsEvent(deliveredRecentLogistics, LocalDateTime.of(2026, 4, 18, 16, 0), "跨境电商已发货"),
            ...
            productRepository.findByCode("SKU-PWR-202").ifPresent(charger ->
                productRepository.findByCode("SKU-CUS-501").ifPresent(keyboard -> {
                    ...
                    saveDemoLogisticsIfMissing(
                        ...
                        null, null, LocalDateTime.of(2026, 6, 2, 15, 0), "跨境电商已发货");
                    saveDemoOrderIfMissing(
    ...
    private void seedLegacyCourseDemoOrders() {
        ...
        saveDemoLogisticsIfMissing(
            ...
            null, null, LocalDateTime.of(2026, 4, 20, 14, 0), "跨境电商已发货");
